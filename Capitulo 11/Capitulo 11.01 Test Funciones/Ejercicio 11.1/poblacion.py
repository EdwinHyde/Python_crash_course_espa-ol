...
# It should now return a single string of the form City, Country – population xxx, such as Santiago, Chile – population
# 5000000.
...
def ciudad_pais(ciudad, pais, poblacion=""):
    if poblacion:
        pais_completo = f"{ciudad} {pais} Población: {poblacion}"
    else:
        pais_completo = f"{ciudad} {pais}"
    return pais_completo.title()

print(ciudad_pais("santiago", "chile", "5000000"))